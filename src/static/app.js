document.addEventListener("DOMContentLoaded", () => {
    ...
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        activityCard.innerHTML = `
          ...
          <p class="availability-line"><strong>Availability:</strong> <span class="availability-badge">${spotsLeft} spots left</span></p>
  ...
  // Handle unregister action from participant delete icons
